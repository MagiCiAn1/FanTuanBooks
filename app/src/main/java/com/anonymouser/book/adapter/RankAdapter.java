...
public class RankAdapter extends RecyclerView.Adapter<RankAdapter.ViewHolder> {
    ...
    List<RankBean.RankingBean.BooksBean> mDatas = new ArrayList<>();
    Context mContext;
    ...
    public void setData(List<RankBean.RankingBean.BooksBean> data) {
        if (data != null) {
            mDatas.clear();
            mDatas.addAll(data);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setUI(int position) {
            RankBean.RankingBean.BooksBean bean = mDatas.get(position);
            try {
